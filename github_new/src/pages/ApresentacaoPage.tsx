...

  {
    ...
    content: (
      <div className="flex flex-col items-center justify-center h-full text-center gap-6">
        <img src="/images/logo-oficial.jpg" alt="Elite" className="w-28 h-28 rounded-2xl shadow-2xl object-cover" />
        <div>
...
const ApresentacaoPage = () => {
  ...
  const handlePptx = async () => {
    ...
    let logoBase64 = "";
    try {
      const resp = await fetch("/images/logo-oficial.jpg");
      ...
      <div className="hidden print:block">
        {slides.map((slide, i) => (
          ...
          >
            ...
            >
              <img src="/images/logo-oficial.jpg" alt="Elite" className="w-10 h-10 rounded object-cover" />
              <div>
